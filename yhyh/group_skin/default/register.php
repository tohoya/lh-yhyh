		...
		<fieldset>
			...
			<table class="yhyh_table_member">
				...
				<tbody>
					...
					<tr><td colspan="4" class="yh_register_width_g"></td></tr>
					<tr class="yhyh_input_text">
						<th><span class="field_title"><? if(!$_m_result->yhb_number) { ?><b class="yh_essential">*</b><? } ?>주민번호</span></th>
						<td colspan="3">
						<? if($_m_result->yhb_number) { ?>
							<?=$_m_result->yhb_kook_no_f ? $_m_result->yhb_kook_no_f : ""?><?=$_m_result->yhb_kook_no_l ? "-".$_LhDb->Text_Replace($_m_result->yhb_kook_no_l, 0, "", "*") : ""?>
						<? } else { ?>
							<input name="yhb_kook_no_f" type="text" onKeyUp="$(this).FormInputNumberCheck(true);" class="text_align_center" id="yhb_kook_no_f" title="주민번호 앞자리" value="<?=$_m_result->yhb_kook_no_f?>" size="10" maxlength="6" alt="필수">
							<label for="yhb_kook_no_f" class="placeHolder">6자리 숫자</label>
							<span>-&nbsp;</span>
							<input name="yhb_kook_no_l" type="password" onKeyUp="$(this).FormInputNumberCheck(true);" class="text_align_center" id="yhb_kook_no_l" title="주민번호 뒷자리" value="<?=$_m_result->yhb_kook_no_l?>" size="14" maxlength="7" alt="필수">
							<label for="yhb_kook_no_l" class="placeHolder">7자리 숫자</label>
						<? } ?>
						</td>
					</tr>
					<tr><td colspan="4" class="yh_register_width_g"></td></tr>
				...
				<!--/tbody>
				<tbody>
					<tr><th colspan="4" class="yh_regist_title"><h2>추가 정보</h2></th></tr-->
					<tr class="yhyh_input_text">
						<th><span class="field_title">직업</span></th>
						<td colspan="3">
							<input type="text" name="yhb_job" id="yhb_job" value="<?=$_m_result->yhb_job?>" size="20" title="직업">
							<label for="yhb_job" class="placeHolder">ex) 자영업</label>
							<span class="field_title">취미</span>
							<input type="text" name="yhb_hobby" id="yhb_hobby" value="<?=$_m_result->yhb_hobby?>" size="20" title="취미">
							<label for="yhb_hobby" class="placeHolder">ex) 운동, 음악감상등</label>
						</td>
					</tr>
					<tr><td colspan="4" class="yh_register_width_g"></td></tr>
					<tr class="yhyh_input_text">
						...
						<td colspan="3">
							<input type="text" name="yhb_homepage" id="yhb_homepage" value="<?=$_m_result->yhb_homepage?>" size="50" title="홈페이지 주소">
							<label for="yhb_homepage" class="placeHolder">ex) http://홈페이지</label>
						</td>
					</tr>
					<tr><td colspan="4" class="yh_register_width_g"></td></tr>
					<tr class="yhyh_input_text">
					...
					<tr class="yhyh_input_text">
						...
						<td colspan="3">
							<select name="yhb_fax_f" id="yhb_fax_f">
								<option value="">선택</option>
							<?
							$_result_count = sizeof($_tel_type);
							for($i = 0; $i < $_result_count; $i++) {
							?>
								<option value="<?=$_tel_type[$i]?>"<?=$_m_result->yhb_fax_f == $_tel_type[$i] ? " selected" : ""?>><?=$_tel_type[$i]?></option>
							<? } ?>
							</select>
							<input name="yhb_fax_m" type="text" id="yhb_fax_m" onKeyUp="$(this).FormInputNumberCheck(true);" class="text_align_center" title="팩스번호 앞자리" value="<?=$_m_result->yhb_fax_m?>" size="8" maxlength="4" alt="">
							<label for="yhb_fax_m" class="placeHolder">ex) 0000</label>
							<input name="yhb_fax_l" type="text" id="yhb_fax_l" onKeyUp="$(this).FormInputNumberCheck(true);" class="text_align_center" title="팩스번호 뒷자리" value="<?=$_m_result->yhb_fax_l?>" size="8" maxlength="4" alt="">
							<label for="yhb_fax_l" class="placeHolder">ex) 0000</label>
						</td>
					</tr>
					<tr><td colspan="4" class="yh_register_width_g"></td></tr>
				</tbody>
				<tbody>
					<tr><th colspan="4" class="yh_regist_title"><h2>학교 정보</h2></th></tr>
					<tr class="yhyh_input_text">
						<th><span class="field_title">학교명</span></th>
						<td colspan="3">
							<input type="text" name="yhb_school_name" id="yhb_school_name" value="<?=$_m_result->yhb_school_name?>" size="30" title="학교이름">
							<label for="yhb_school_name" class="placeHolder">ex) **대학교, **고등학교</label>
							<span class="field_title">전화번호</span>
							<select name="yhb_school_tel_f" id="yhb_school_tel_f">
								<option value="">선택</option>
							<?
							$_result_count = sizeof($_tel_type);
							for($i = 0; $i < $_result_count; $i++) {
							?>
								<option value="<?=$_tel_type[$i]?>"<?=$_m_result->yhb_school_tel_f == $_tel_type[$i] ? " selected" : ""?>><?=$_tel_type[$i]?></option>
							<? } ?>
							</select>
							<input name="yhb_school_tel_m" type="text" onKeyUp="$(this).FormInputNumberCheck(true);" class="text_align_center" id="yhb_school_tel_m" title="학교 전화번호 앞자리" value="<?=$_m_result->yhb_school_tel_m?>" size="8" maxlength="4" alt="">
							<label for="yhb_school_tel_m" class="placeHolder">ex) 0000</label>
							<input name="yhb_school_tel_l" type="text" onKeyUp="$(this).FormInputNumberCheck(true);" class="text_align_center" id="yhb_school_tel_l" title="학교 전화번호 뒷자리" value="<?=$_m_result->yhb_school_tel_l?>" size="8" maxlength="4" alt="">
							<label for="yhb_school_tel_l" class="placeHolder">ex) 0000</label>
						</td>
					</tr>
					<tr><td colspan="4" class="yh_register_width_g"></td></tr>
					<tr class="yhyh_input_text">
						<th><span class="field_title">학과</span></th>
						<td colspan="3">
							<input type="text" name="yhb_school_class" id="yhb_school_class" value="<?=$_m_result->yhb_school_class?>" size="20" title="학과">
							<label for="yhb_school_class" class="placeHolder">ex) **과등</label>
							<span class="field_title">학년</span>
							<input type="text" name="yhb_school_year" id="yhb_school_year" value="<?=$_m_result->yhb_school_year?>" size="10" title="학년">
							<label for="yhb_school_year" class="placeHolder">ex) 1학년</label>
							<span class="field_title">반</span>
							<input type="text" name="yhb_school_section" id="yhb_school_section" value="<?=$_m_result->yhb_school_section?>" size="10" title="반">
							<label for="yhb_school_section" class="placeHolder">ex) 1반</label>
							<span class="field_title">학번</span>
							<input type="text" name="yhb_school_number" id="yhb_school_number" value="<?=$_m_result->yhb_school_number?>" size="15" title="학번">
							<label for="yhb_school_number" class="placeHolder">학번</label>
						</td>
					</tr>
					<tr><td colspan="4" class="yh_register_width_g"></td></tr>
					<tr class="yhyh_input_text">
						...
						<td colspan="3">
							<table class="yh_address_form">
								<tbody>
									<tr>
										<td>
											<input type="text" name="yhb_school_post" class="text_align_center" id="yhb_school_post" value="<?=$_m_result->yhb_school_post?>" size="12" title="우편번호검색">
											<label for="yhb_school_post" class="placeHolder">ex) 000-000</label>
											<input type="button" value="우편번호검색">
										</td>
									</tr>
									<tr>
										<td>
											<input type="text" name="yhb_school_address" id="yhb_school_address" value="<?=$_m_result->yhb_school_address?>" size="60" title="학교 주소">
											<label for="yhb_school_address" class="placeHolder">ex) 서울시 영등포구 문래동</label>
										</td>
									</tr>
									<tr>
										<td>
											<input type="text" name="yhb_school_address_etc" id="yhb_school_address_etc" value="<?=$_m_result->yhb_school_address_etc?>" size="50" title="나머지 주소">
											<label for="yhb_school_address_etc" class="placeHolder">ex) 번지, 층, 호</label>
										</td>
									</tr>
								</tbody>
							</table>
				...
				<tbody>
					<tr><th colspan="4" class="yh_regist_title"><h2>직장 정보</h2></th></tr>
					<tr class="yhyh_input_text">
						<th><span class="field_title">회사명</span></th>
						<td colspan="3">
							<input type="text" name="yhb_office_name" id="yhb_office_name" value="<?=$_m_result->yhb_office_name?>" size="30" title="회사이름">
							<label for="yhb_office_name" class="placeHolder">ex) *** 주식회사</label>
							<span class="field_title">대표자명</span>
							<input type="text" name="yhb_office_owner" id="yhb_office_owner" value="<?=$_m_result->yhb_office_owner?>" size="20" title="대표자명">
							<label for="yhb_office_owner" class="placeHolder">대표자명</label>
						</td>
					</tr>
					<tr><td colspan="4" class="yh_register_width_g"></td></tr>
					<tr class="yhyh_input_text">
						...
						<td colspan="3">
							<input name="yhb_office_no_f" type="text" onKeyUp="$(this).FormInputNumberCheck(true);" class="text_align_center" id="yhb_office_no_f" title="사업자번호 앞자리" value="<?=$_m_result->yhb_office_no_f?>" size="7" maxlength="3">
							<label for="yhb_office_no_f" class="placeHolder">ex) 123</label>
							<span>-&nbsp;</span>
							<input name="yhb_office_no_m" type="text" onKeyUp="$(this).FormInputNumberCheck(true);" class="text_align_center" id="yhb_office_no_m" title="사업자번호 중간자리" value="<?=$_m_result->yhb_office_no_m?>" size="6" maxlength="2">
							<label for="yhb_office_no_m" class="placeHolder">ex) 45</label>
							<span>-&nbsp;</span>
							<input name="yhb_office_no_l" type="text" onKeyUp="$(this).FormInputNumberCheck(true);" class="text_align_center" id="yhb_office_no_l" title="사업자번호 뒷자리" value="<?=$_m_result->yhb_office_no_l?>" size="9" maxlength="5">
							<label for="yhb_office_no_l" class="placeHolder">ex) 67890</label>
							<span class="field_title">전화번호</span>
							<select name="yhb_office_tel_f" id="yhb_office_tel_f">
								<option value="">선택</option>
							<?
							$_result_count = sizeof($_tel_type);
							for($i = 0; $i < $_result_count; $i++) {
							?>
								<option value="<?=$_tel_type[$i]?>"<?=$_m_result->yhb_office_tel_f == $_tel_type[$i] ? " selected" : ""?>><?=$_tel_type[$i]?></option>
							<? } ?>
							</select>
							<input name="yhb_office_tel_m" type="text" onKeyUp="$(this).FormInputNumberCheck(true);" class="text_align_center" id="yhb_office_tel_m" title="학교 전화번호 앞자리" value="<?=$_m_result->yhb_office_tel_m?>" size="8" maxlength="4" alt="">
							<label for="yhb_office_tel_m" class="placeHolder">ex) 0000</label>
							<input name="yhb_office_tel_l" type="text" onKeyUp="$(this).FormInputNumberCheck(true);" class="text_align_center" id="yhb_office_tel_l" title="학교 전화번호 뒷자리" value="<?=$_m_result->yhb_office_tel_l?>" size="8" maxlength="4" alt="">
							<label for="yhb_office_tel_l" class="placeHolder">ex) 0000</label>
						</td>
					</tr>
					<tr><td colspan="4" class="yh_register_width_g"></td></tr>
					<tr class="yhyh_input_text">
						...
						<td colspan="3">
							<input type="text" name="yhb_office_project" id="yhb_office_project" value="<?=$_m_result->yhb_office_project?>" size="20" title="종목">
							<label for="yhb_office_project" class="placeHolder">ex) 인터넷 서비스</label>
							<span class="field_title">업태</span>
							<input type="text" name="yhb_office_kind" id="yhb_office_kind" value="<?=$_m_result->yhb_office_kind?>" size="20" title="업태">
							<label for="yhb_office_kind" class="placeHolder">ex) 유통, 제조</label>
							<span class="field_title">회사유형</span>
							<input type="text" name="yhb_kind_style" id="yhb_kind_style" value="<?=$_m_result->yhb_kind_style?>" size="20" title="회사유형">
							<label for="yhb_kind_style" class="placeHolder">ex) 무역, 제조</label>
						</td>
					</tr>
					<tr><td colspan="4" class="yh_register_width_g"></td></tr>
					<tr class="yhyh_input_text">
						...
						<td colspan="3">
							<table class="yh_address_form">
								<tbody>
									<tr>
										<td>
											<input type="text" name="yhb_office_post" class="text_align_center" id="yhb_office_post" value="<?=$_m_result->yhb_office_post?>" size="12" title="우편번호검색">
											<label for="yhb_office_post" class="placeHolder">ex) 000-000</label>
											<input type="button" value="우편번호검색">
										</td>
									</tr>
									<tr>
										<td>
											<input type="text" name="yhb_office_address" id="yhb_office_address" value="<?=$_m_result->yhb_office_address?>" size="60" title="학교 주소">
											<label for="yhb_office_address" class="placeHolder">ex) 서울시 영등포구 문래동</label>
										</td>
									</tr>
									<tr>
										<td>
											<input type="text" name="yhb_office_address_etc" id="yhb_office_address_etc" value="<?=$_m_result->yhb_office_address_etc?>" size="50" title="나머지 주소">
											<label for="yhb_office_address_etc" class="placeHolder">ex) 번지, 층, 호</label>
										</td>
									</tr>
								</tbody>
							</table>
				...
				<tbody>
					<tr><th colspan="4" class="yh_regist_title"><h2>담당자 정보</h2></th></tr>
					<tr class="yhyh_input_text">
						<th><span class="field_title">담당자 이름</span></th>
						<td colspan="3">
							<input type="text" name="yhb_office_charge" id="yhb_office_charge" value="<?=$_m_result->yhb_office_charge?>" size="20" title="담당자 이름">
							<label for="yhb_office_charge" class="placeHolder">ex) 담당자 이름</label>
							<span class="field_title">담당자 연락처</span>
							<select name="yhb_office_charge_tel_f" id="yhb_office_charge_tel_f">
								<option value="">선택</option>
							<?
							$_result_count = sizeof($_tel_type_all);
							for($i = 0; $i < $_result_count; $i++) {
							?>
								<option value="<?=$_tel_type_all[$i]?>"<?=$_m_result->yhb_office_charge_tel_f == $_tel_type_all[$i] ? " selected" : ""?>><?=$_tel_type_all[$i]?></option>
							<? } ?>
							</select>
							<input name="yhb_office_charge_tel_m" type="text" onKeyUp="$(this).FormInputNumberCheck(true);" class="text_align_center" id="yhb_office_charge_tel_m" title="담당자 연락처 앞자리" value="<?=$_m_result->yhb_office_charge_tel_m?>" size="8" maxlength="4" alt="">
							<label for="yhb_office_charge_tel_m" class="placeHolder">ex) 0000</label>
							<input name="yhb_office_charge_tel_l" type="text" onKeyUp="$(this).FormInputNumberCheck(true);" class="text_align_center" id="yhb_office_charge_tel_l" title="담당자 연락처 뒷자리" value="<?=$_m_result->yhb_office_charge_tel_l?>" size="8" maxlength="4" alt="">
							<label for="yhb_office_charge_tel_l" class="placeHolder">ex) 0000</label>
						</td>
					</tr>
					<tr><td colspan="4" class="yh_register_width_g"></td></tr>
					<tr class="yhyh_input_text">
						...
						<td colspan="3">
							<input type="text" name="yhb_office_level" id="yhb_office_level" value="<?=$_m_result->yhb_office_level?>" size="20" title="부서">
							<label for="yhb_office_level" class="placeHolder">ex) **부</label>
							<span class="field_title">직책</span>
							<input type="text" name="yhb_office_position" id="yhb_office_position" value="<?=$_m_result->yhb_office_position?>" size="20" title="직책">
							<label for="yhb_office_position" class="placeHolder">ex) 차장, 부장, 과장등</label>
						</td>
					</tr>
					<tr><td colspan="4" class="yh_register_width_g"></td></tr>
				</tbody>
