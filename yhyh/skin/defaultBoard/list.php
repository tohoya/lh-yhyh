	...
	<table>
		...
		?>
			<tr>
				...
				<td class="title"><?=$_bb->icon_viewer?><a href="<?=$_bb->title_link?>" class="ellipsis_title" title="<?=htmlspecialchars($_bb->title)?>"><?=$_bb->icon_reply?><?=$_bb->icon_notice?><?=$_bb->icon_secret?><?=$_bb->icon_new?><?=$_bb->title?></a></td>
